...
import successfull from './success.png';
    ...
    <>
      ...
      <main className="w-full mt-20">
        ...
        <div className="flex flex-col gap-2 items-center justify-center sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow rounded p-6 pb-12">
          ...
          <h1 className="text-2xl font-semibold">Notification sent succesfully {success ? 'Successfull' : 'Failed'}</h1>
          <p className="mt-4 text-lg text-gray-800">Redirecting to explore page in {time} sec</p>
          <Link
