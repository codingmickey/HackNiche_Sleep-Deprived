			...
			>
				<div>
					...
					<h3 style={{ margin: "0", color: "white", maxWidth: "600px" }}>
						The most common mental health problems among personnel and veterans
						are depression, anxiety and alcohol problems. Most common experience
				...
				<Card sx={{ maxWidth: 300 }}>
					...
					<CardContent>
						<Typography variant="body2" sx={{ color: "#2c645b" }}>
							Amazing mental health resources to combat anxiety, depression and
							much more.
						</Typography>
